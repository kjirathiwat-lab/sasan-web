...
เพราะคุณสมควรได้รับสิ่งที่ดีที่สุด... จนวินาทีสุดท้าย`,
  ...
  },
  {
    ...
    content: `Celebration of Life - งานที่อบอุ่น ไม่ใช่หดหู่

แทนที่จะนั่งร้องไห้... ให้คนที่รักมารวมตัวกันเพื่อ "ขอบคุณ" ช่วงเวลาดีๆ ที่มีร่วมกับคุณ

มีเพลงโปรด มีอาหารที่คุณชอบ มีรูปภาพความทรงจำ มีเสียงหัวเราะ และมีรอยยิ้ม

นี่คืองานศพที่คุณอยากให้เป็น`,
